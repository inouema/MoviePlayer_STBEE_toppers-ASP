...
/*!
	...
	@brief          Based on Chan's MCI_OLED@LPC23xx-demo thanks!				 	 	 @n
					Available TFT-LCM are listed below.							 	 	 @n
					 ...
					 -NHD-2.4-240320SF-CTXI#-T1 (ILI9340)	8/16bit.
...
inline uint16_t ILI934x_rd_cmd(uint8_t cmd)
{
	...
	return val;
#else
	return 0x9341;   /* Read function NOT WORK on SDT028ATFT */
#endif
}
...
void ILI934x_init(void)
{
	...
	rest       = ILI934x_rd_cmd(0x09);  		/* Confirm Vaild LCD Controller for SDT028A&SDT022A */

	if((devicetype == 0x9340) || (devicetype == 0x9341) || (rest == 0x3080)) /* 0x3080 is SDT028A&SDT022A Work Around */
	{
		/* Initialize ILI934x */
