...
/*!
	...
	@brief          Based on Chan's MCI_OLED@LPC23xx-demo thanks!				@n
					Available TFT-LCM are listed below.							@n
					 ...
					 -TF2213A3(B) Ready	  		(HX8346A)	8/16bit mode.		@n
...
inline void HX8347x_wr_cmd(uint8_t cmd)
{
	...
	/* Might Need for HX8347A on Fasest bus,HX8347D DOES NOT needed... */
...
void HX8347x_init(void)
{
	...
	else if(id834xA == 0x46)
	{
		...
		HX8347x_wr_cmd(0x16);
		HX8347x_wr_dat(0x18);			/* MY=0, MX=0, MV=0, ML=0, BGR=0, TEON=0 */
