...
/*!
	...
	@brief          Based on Chan's MCI_OLED@LPC23xx-demo thanks!				@n
					Available TFT-LCM are listed below.							@n
					 ...
					 -FPC-S93235Z	(ILI9163B)	4-Wire,8-bitSerial.				@n


    @section HISTORY
		2011.12.23	V1.00	Revised From ILI9163B Driver.
		2012.01.18	V2.00	Added FPC-S93235Z Module Support.
...
#if __ILI9163X_H != 0x0300
#error "header file version is not correspond!"
#endif

/* Defines -------------------------------------------------------------------*/
#if defined(USE_FPC_S93235Z)
 #warning "You Select FPC-S93235Z V01 Module(ILI9163B)!"
#elif  defined(USE_SGP18T_00)
 #warning "You Select SGP18T-00 Module(ILI9163B)!"
#elif  defined(USE_SDT018ATFT)
 #warning "You Select SDT018ATFT Module(ILI9163C)!"
#else
