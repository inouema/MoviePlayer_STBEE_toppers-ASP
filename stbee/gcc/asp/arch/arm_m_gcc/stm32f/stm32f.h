...
/* SPI Register */
#define SPI1_CR1				(SPI1_BASE + 0x00) /* 制御レジスタ-1 */
#define SPI1_CR1_BIT_BR_2       (0x0000)
#define SPI1_CR1_BIT_BR_4       (0x0008)
#define SPI1_CR1_BIT_BR_256     (0x0038)
#define SPI1_CR2				(SPI1_BASE + 0x04) /* 制御レジスタ-2 */
#define SPI1_SR					(SPI1_BASE + 0x08) /* ステータス・レジスタ */
#define SPI1_SR_BIT_TXE         (1<<1)
#define SPI1_SR_BIT_RXNE        (1<<0)
#define SPI1_DR					(SPI1_BASE + 0x0c) /* データレジスタ */
